...
/*   Updated: 2021/04/02 16:16:31 by kmacquet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ra(t_data *data)
{
	...
	if (!data->stack_a->next)
		ft_error("Can't rotate stack A if there is less than 2 elements");
	s_init = data->stack_a;
...
void		rb(t_data *data)
{
	...
	if (!data->stack_b->next)
		ft_error("Can't rotate stack B if there is less than 2 elements");
	s_init = data->stack_b;
